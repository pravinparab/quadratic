...
function __wbg_adapter_22(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd285fefc356cea59(arg0, arg1, addHeapObject(arg2));
}
...
export function eval_formula(formula_string, x, y, grid_accessor_fn) {
    ...
    const ret = wasm.eval_formula(ptr0, len0, x, y, addHeapObject(grid_accessor_fn));
...
export function column_from_name(s) {
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.column_from_name(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
...
export function provideCompletionItems(_text_model, _position, _context, _token) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.provideCompletionItems(retptr, addHeapObject(_text_model), addHeapObject(_position), addHeapObject(_context), addHeapObject(_token));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
export function provideHover(text_model, position, _token) {
    const ret = wasm.provideHover(addHeapObject(text_model), addHeapObject(position), addHeapObject(_token));
    return takeObject(ret);
}
...
function __wbg_adapter_51(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h14f5da906b7ee0cc(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}

/**
*/
export const CellTypes = Object.freeze({ Text:0,"0":"Text",Formula:1,"1":"Formula",Javascript:2,"2":"Javascript",Python:3,"3":"Python",Sql:4,"4":"Sql",Computed:5,"5":"Computed", });
/**
* Cell position {x, y}.
*/
export class Pos {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_c576ff7510ad2f07 = function(arg0, arg1) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('quadratic_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
